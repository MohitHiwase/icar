export default function SideNav() {
  return (
    <aside className="w-64 flex-shrink-0 h-full flex flex-col z-40 bg-surface border-r border-outline-variant/30 p-4">
      <div className="h-16 flex items-center gap-sm mb-2 px-2">
        <span className="font-headline-sm text-primary tracking-tight font-bold text-xl">AgriData</span>
      </div>
      <nav className="flex-1 py-sm space-y-1 overflow-y-auto custom-scrollbar">
