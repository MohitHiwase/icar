...
export default function TopNavBar() {
  ...
  return (
    <header className="h-[64px] shrink-0 bg-[var(--bg-surface)] backdrop-blur-[36px] backdrop-saturate-180 border-b border-[var(--border-subtle)] flex items-center justify-between px-6 z-20 sticky top-0 w-full transition-colors duration-200">
